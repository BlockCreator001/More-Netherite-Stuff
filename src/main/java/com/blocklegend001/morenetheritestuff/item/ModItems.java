...
import com.blocklegend001.morenetheritestuff.item.custom.*;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, MoreNetheriteStuffMod.MOD_ID);

    public static final RegistryObject<Item> NETHERITE_T1_INGOT = ITEMS.register("netherite_t1_ingot",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.MORENETHERITESTUFF_TAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_T1_APPLE = ITEMS.register("netherite_t1_apple",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.MORENETHERITESTUFF_TAB).food(ModFoods.NETHERITE_T1_APPLE)));

    public static final RegistryObject<Item> NETHERITE_T2_APPLE = ITEMS.register("netherite_t2_apple",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.MORENETHERITESTUFF_TAB).food(ModFoods.NETHERITE_T2_APPLE)));

    public static final RegistryObject<Item> NETHERITE_T3_APPLE = ITEMS.register("netherite_t3_apple",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.MORENETHERITESTUFF_TAB).food(ModFoods.NETHERITE_T3_APPLE)));

    public static final RegistryObject<Item> NETHERITE_4_APPLE = ITEMS.register("netherite_t4_apple",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.MORENETHERITESTUFF_TAB).food(ModFoods.NETHERITE_T4_APPLE)));
    ...
    public static final RegistryObject<Item> NETHERITE_T1_SWORD = ITEMS.register("netherite_t1_sword",
            () -> new SwordItem(ModTiers.NETHERITE_T1, 13, -2.4f,
                    new Item.Properties().tab(ModCreativeModeTab.MORENETHERITESTUFF_TAB)));
    ...
    public static final RegistryObject<Item> DATA_TABLET = ITEMS.register("data_tablet",
            () -> new DataTabletItem(new Item.Properties().tab(ModCreativeModeTab.MORENETHERITESTUFF_TAB).stacksTo(1)));
